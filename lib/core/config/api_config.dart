...
// teléfono (motor CameraX + MediaPipe); estas rutas no procesan frames ni
// imágenes de cámara.
...
static String vestidorConfiguracionesUrlDesde(
  String base,
  int productoId,
) =>
...
static String get vestidorSesionesUrl =>
    vestidorSesionesUrlDesde(baseUrl);
...
static String vestidorSesionPruebasUrlDesde(
  String base,
  int sesionId,
) =>
...
static String vestidorPruebaFinalizarUrlDesde(
  String base,
  int pruebaId,
) =>
...
static String vestidorSesionFinalizarUrlDesde(
  String base,
  int sesionId,
) =>
